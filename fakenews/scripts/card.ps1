...
$g.Clear([System.Drawing.ColorTranslator]::FromHtml('#221826'))
$lime=New-Object System.Drawing.SolidBrush ([System.Drawing.ColorTranslator]::FromHtml('#ffd23f'))
...
try {
  ...
  $g.DrawString('THE ARTIFICIAL NEWS',$brand,$white,96,62)
  $g.DrawString('SATIRE /  '+$s.category.ToUpper(),$small,$lime,64,433)
  ...
  $g.DrawString('INVERSO LABS  /  FICTIONAL COMEDY',$small,$muted,64,1180)
  $g.DrawString('Read the briefing at inversolabs.us/fakenews',$small,$white,64,1240)
