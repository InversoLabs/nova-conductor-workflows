...
export async function publishBulletin(folder){
  ...
  try{
    ...
    const html=`<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>The Daily Nonsense | ${esc(b.editionDate)} — TAN / SATIRE</title><link rel="stylesheet" href="/fakenews/style.css"><main style="max-width:1100px;margin:40px auto;padding:24px"><a href="/fakenews/">← THE ARTIFICIAL NEWS newsroom</a><h1 style="margin:24px 0">The Daily Nonsense · ${esc(b.editionDate)}</h1><p>With Mara Vale${b.kind==='scheduled'?'':' · Launch-edition studio test'}</p><video controls playsinline preload="metadata" style="width:100%;background:#0d1b1b" src="website.mp4"></video><p><a href="instagram.mp4">Watch the vertical edition ↗</a></p><h2>In this bulletin</h2><ul>${links}</ul><p>SATIRE: Fictional comedy inspired by real reporting. Mara Vale is a fictional presenter.</p></main></html>`;
